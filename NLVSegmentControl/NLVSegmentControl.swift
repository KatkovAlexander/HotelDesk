//
//  NLVSegmentControl.swift
//  Nalavashe
//
//  Created by Alexander on 17.01.2022.
//
...
protocol NLVSegmentControlDelegate: AnyObject {
    
    func onSegmentControl(_ index: Int)
    func onSegmentControl(_ index: Int, control: NLVSegmentControl)
}

extension NLVSegmentControlDelegate {
   
    func onSegmentControl(_ index: Int) { }
    func onSegmentControl(_ index: Int, control: NLVSegmentControl) { }
}

class NLVSegmentControl: UIView, NibLoadable {
    
    // MARK: Open properties
    
    weak var delegate: NLVSegmentControlDelegate?
    ...
    @IBOutlet private weak var segmentsStackView: UIStackView!
    @IBOutlet private weak var slidingSegmentView: BNDesignableView! {
        didSet {
