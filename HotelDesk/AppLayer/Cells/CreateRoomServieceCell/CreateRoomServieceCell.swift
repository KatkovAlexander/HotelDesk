...
class CreateRoomServieceCell: UITableViewCell {
    
    weak var delegate: CreateRoomServieceCellDelegate?
    ...
    func bind(model: CreateRoomServieceCellModel) {
